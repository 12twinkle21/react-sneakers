...
function Card({id, title, price, imgUrl ,onFavorite, onPlus, loaded = false}) {

   const { isItemAddedToCart, isItemAddedToFavorite } = React.useContext(AppContext);
   
   const objSettings = { id, parentId: id, title, price, imgUrl };
          ...
          >
            ...
            <rect x="117" y="230" rx="10" ry="10" width="32" height="32" />
               ...
               <>
                  ...
                  <img src={imgUrl} width='100%' height={135} alt='Sneakers'/>
                     <p>{title}</p>
                  <div className={styles.bottom}>
                     ...
                     {  onPlus?
                        ...
                        <img className={styles.noActiveBtn} onClick={onClickPlus} src='/img/noActiveCard.svg' alt='Plus' />
                        :
                        <img className={styles.activeBtn} onClick={onClickPlus} src='/img/activeCard.svg' alt='Plus' />
                        :
                        undefined
                     }
                     </div>
